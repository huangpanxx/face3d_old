...
int nInitializedModels = 0;

void InitAsmModels(
	const char _sConfFile0[], // in: 1st config filename
	const char _sConfFile1[], // in: 2nd config filename, "" if none
	const char _sDataDir[]   // in: data directory
){
	strcpy(sConfFile0,_sConfFile0);
	strcpy(sConfFile1,_sConfFile1);
	strcpy(sDataDir,_sDataDir);
